            ...
            <tr>
                ...
                <td>
                    @if ($modalId == $exam_custom_question->id)
                        ...
                        @enderror
                    @else
                        {{ $exam_custom_question->question_count }}
                    @endif
                </td>
                <td>
                    @if ($modalId == $exam_custom_question->id)
                    ...
                    @else
                        <button type="button" class="btn btn-info btn-sm"
                                wire:click.prevent="edit('{{$exam_custom_question->id}}',{{$exam_custom_question->question_count}})"
        ...
        <div class="col-md-12">
            ...
            <div class="form-row">
                <div class="col">
                    ...
                    <select class="form-control form-white" style="padding: 10px" wire:model.defer="quran_part_id">
