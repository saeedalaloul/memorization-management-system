    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">اعتماد اختبار التجميعي</h5>
            ...
            <div class="modal-body p-20">
                <form>
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <label class="control-label">درجة اختبار التجميعي النهائية</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click="examApproval()" class="btn btn-success ripple">اعتماد اختبار التجميعي
                </button>
            </div>
        </div>
    </div>
