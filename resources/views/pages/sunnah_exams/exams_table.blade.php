                ...
                <div class="col-md-3">
                    ...
                    <div>
                        <select style="width: 100%;" class="custom-select mr-sm-2 select2" id="type-exams"
                            ...
                            <option value="">الكل</option>
                            @foreach(\App\Models\SunnahPart::types() as $key => $type)
...
{{--                @endif--}}
    ...
    @include('pages.sunnah_exams.import_file')
        ...
        <table class="table center-aligned-table mb-0">
            ...
            @forelse($exams as $exam)
                <tr>
                    ...
                    <td>{{ $exam->SunnahPart->name . ' (' . $exam->SunnahPart->total_hadith_parts . ') حديث' }}</td>
                                ...
                                @if($current_role == \App\Models\User::TEACHER_ROLE)
                                    @if ($exam->mark >= $exam->exam_success_mark->mark && $exam->exam_improvement == null)
                                        <button class="dropdown-item"
                                                wire:click="submitExamImprovementRequest('{{$exam->student_id}}',{{$exam->sunnah_part_id}});">
                                            <i style="color: blue"
                ...
                @include('pages.sunnah_exams.manage-exam')
                @include('pages.sunnah_exams.manage-external-exam')
            @empty
