<div wire:ignore.self class="modal" tabindex="-1" role="dialog" id="select-group-custom" style="display: none;"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">إضافة حلقات على الإجراء</h5>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select style="padding: 1px;" class="form-control form-white"
                                wire:model.defer="selectedGradeId" id="grade_select">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select wire:model.defer="groups_ids" style="width: 100%;" multiple>
                                @if (isset($groups))
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click="approval_on_group();" class="btn btn-success ripple">
