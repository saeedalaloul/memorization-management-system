<div wire:ignore.self class="modal" tabindex="-1" role="dialog" id="reset-data-daily-memorization"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="custom-control custom-radio mb-3">
                                <input type="radio" value="1" wire:model="reset_data_daily_memorization_type"
                                ...
                                <label class="custom-control-label" for="customControlValidation2">تصفير لبداية الجزء
                                    الحالي</label>
                                <div
                                    class="badge badge-danger font-weight-bold">{{$reset_data_daily_memorization_type == 1 ? $message_warning_reset_data : ""}}</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="custom-control custom-radio mb-3">
                                <input type="radio" value="2" wire:model="reset_data_daily_memorization_type"
                                ...
                                <label class="custom-control-label" for="customControlValidation3">تصفير جميع
                                    البيانات</label>
                                <div
                                    class="badge badge-danger font-weight-bold">{{$reset_data_daily_memorization_type == 2 ? $message_warning_reset_data : ""}}</div>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" wire:click="reset_daily_memorization();"
