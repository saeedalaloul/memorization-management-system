    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body" x-data="{currentPermissionTab: $persist('grade')}">
                <h5 class="card-title" style="font-size: 15px; color: #1e7e34">تعديل صلاحيات دور({{$role_name ?? ''}})</h5>
                                        ...
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة المراحل')"
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إضافة مرحلة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إضافة مرحلة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('تعديل مرحلة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                تعديل مرحلة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('حذف مرحلة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                حذف مرحلة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة المجموعات')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إدارة المجموعات
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إضافة مجموعة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إضافة مجموعة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('نقل مجموعة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                نقل مجموعة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('تعديل مجموعة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                تعديل مجموعة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('حذف مجموعة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                حذف مجموعة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('سحب محفظ من مجموعة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                سحب محفظ من مجموعة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة مشرفي المراحل')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إدارة مشرفي المراحل
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إضافة مشرف مرحلة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إضافة مشرف مرحلة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('تعديل مشرف مرحلة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                تعديل مشرف مرحلة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('حذف مشرف مرحلة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                حذف مشرف مرحلة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة المحفظين')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إدارة المحفظين
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إضافة محفظ')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إضافة محفظ
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة حضور وغياب المحفظين')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('تعديل محفظ')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                تعديل محفظ
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('حذف محفظ')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                حذف محفظ
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة الطلاب')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إدارة الطلاب
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إضافة طالب')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إضافة طالب
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('عرض طالب')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                عرض طالب
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('تعديل طالب')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                تعديل طالب
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('حذف طالب')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                حذف طالب
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة تقرير الحفظ والمراجعة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة متابعة الحفظ والمراجعة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('تصفير بيانات الحفظ والمراجعة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة التقارير الشهرية')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة الإختبارات')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إدارة الإختبارات
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إضافة اختبار')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إضافة اختبار
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إعدادات الإختبارات')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إعدادات الإختبارات
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة اختبارات اليوم')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة طلبات الإختبارات')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إجراء طلب اختبار')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إجراء طلب اختبار
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إجراء الإختبار')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إجراء الإختبار
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة المختبرين')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إدارة المختبرين
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إضافة مختبر')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إضافة مختبر
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('حذف مختبر')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                حذف مختبر
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة الأنشطة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إدارة الأنشطة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة طلبات الأنشطة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إدارة طلبات الأنشطة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إجراء طلب نشاط')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إجراء طلب نشاط
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة أنواع الأنشطة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إدارة أنواع الأنشطة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إضافة نوع نشاط')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إضافة نوع نشاط
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('تعديل نوع نشاط')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                تعديل نوع نشاط
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة أعضاء الأنشطة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إدارة أعضاء الأنشطة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إضافة منشط')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إضافة منشط
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة أعضاء الرقابة')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إدارة أعضاء الرقابة
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إضافة مراقب')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إضافة مراقب
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة صندوق الشكاوي والإقتراحات')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('تقديم شكوى/اقتراح')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                تقديم شكوى/اقتراح
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة الاجراءات العقابية')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إضافة اجراء عقابي')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إضافة اجراء عقابي
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('تعديل اجراء عقابي')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                تعديل اجراء عقابي
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('حذف اجراء عقابي')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                حذف اجراء عقابي
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة المستخدمين')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إدارة المستخدمين
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إضافة مستخدم')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إضافة مستخدم
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('تعديل مستخدم')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                تعديل مستخدم
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('حذف مستخدم')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                حذف مستخدم
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('إدارة الأدوار')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                إدارة الأدوار
                                            </label>
                                    ...
                                    <div class="mb-3">
                                        <div class="checkbox checbox-switch switch-success">
                                            <label>
                                                ...
                                                @endforeach
                                                <input type="checkbox" name="switch"
                                                       wire:click="update_role_permission('تعديل دور')"
                                                    {{ $isCheck== true ? "checked" : ""}}>
                                                <span></span>
                                                تعديل دور
                                            </label>
