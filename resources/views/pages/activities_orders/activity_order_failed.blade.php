<div wire:ignore.self class="modal" tabindex="-1" role="dialog" id="failed-activity" style="display: none;"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">لم يتم إجراء النشاط</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click="activity_failed();" class="btn btn-success ripple">لم
                    يتم إجراء النشاط
                </button>
            </div>
        </div>
