<!-- edit_modal_Grade -->
<div wire:ignore.self class="modal fade" id="gradeEdited" tabindex="-1" role="dialog"
                ...
                <div class="row">
                    <div class="col">
                        <label for="name"
                            ...
                            :</label>
                        <input id="name" type="text" name="name" wire:model.defer="name"
                               class="form-control"
                               required>
                        @error('name')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <input id="id" type="hidden" name="id" class="form-control" wire:model.defer="modalId">
                    </div>
                    ...
                    <div class="col">
                        ...
                        <select class="form-control form-white" wire:model.defer="section"
                                style="padding: 1px">
                            <option value="">اختر قسم المرحلة</option>
