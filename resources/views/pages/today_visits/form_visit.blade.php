<div class="form-group">
    ...
    <textarea wire:model.defer="notes" class="form-control" name="summernote"
...
<div class="form-group">
    ...
    <textarea wire:model.defer="suggestions" class="form-control" name="summernote"
...
<div class="form-group">
    ...
    @endif
    <textarea wire:model.defer="recommendations" class="form-control" name="summernote"
...
<div class="form-group">
    ...
    <a class="button button-border" wire:click="sendVisit();">إرسال الزيارة</a>
</div>
