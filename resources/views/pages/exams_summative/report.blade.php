<table>
    ...
    @forelse($exams as $exam)
        <tr>
            ...
            <td style="border:solid;font-weight: bold;font-size: 12px;font-family: Calibri;text-align:center;vertical-align: center;">{{ $exam->QuranPart->QuranSummativePartName() }}</td>
