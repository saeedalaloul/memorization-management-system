            ...
            <div class="card-body" x-data="{currentTab: $persist('home')}">
                ...
                <div class="tab tab-border">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item" @click.prevent="currentTab = 'home'">
                            <a class="nav-link {{$process_type == '' ? 'active show':''}}" href="#" :class="currentTab === 'home' ? 'active show':'' "
                               ...
                               data-bs-toggle="tab" role="tab" aria-controls="visits-orders-05" aria-selected="true"> <i
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade {{$process_type == '' ? 'active show':''}}" :class="currentTab === 'home' ? 'active show':'' " id="visits-orders-05"
                             role="tabpanel"
