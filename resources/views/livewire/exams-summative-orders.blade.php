                        ...
                        <table class="table center-aligned-table mb-0">
                            ...
                            @forelse($exam_orders as $exam_order)
                                <tr>
                                    ...
                                    <td>{{ $exam_order->QuranPart->QuranSummativePartName() }}</td>
                                ...
                                @include('pages.exams_summative_orders.exam_order_approval')
                                @include('pages.exams_summative_orders.exam_order_refusal')
                                @include('pages.exams_summative_orders.delete_exam_order')
                            @empty
