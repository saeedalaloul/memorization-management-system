<div>
    @if ($current_role === \App\Models\User::ACTIVITIES_SUPERVISOR_ROLE ||  $current_role === \App\Models\User::SUPERVISOR_ROLE
                    ...
                    <div class="tab tab-border">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item" @click.prevent="currentTab = 'form'">
                                <a class="nav-link "
                                   id="add-activity-order-05-tab" data-bs-toggle="tab" role="tab"
                                   :class="currentTab === 'form' ? 'active show':'' " href="#"
