        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body" x-data="{currentTab: $persist('home')}">
                    <h5 class="card-title">إدارة مشرفي الحلقات المكفولة</h5>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade" :class="currentTab === 'home' ? 'active show':'' "
                                ...
                                @can('إدارة مشرفي الحلقات المكفولة')
                                    @include('pages.sponsorship_supervisors.supervisors_table')
                                @endcan
                            </div>
                            ...
                            <div class="tab-pane fade" :class="currentTab === 'form' ? 'active show':'' "
                                ...
                                @can('إضافة مشرف حلقات مكفولة')
                                    @include('pages.sponsorship_supervisors.supervisor_form')
                                @endcan
                            </div>
                        </div>
                    </div>
