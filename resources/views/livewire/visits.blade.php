<div>
    @if ($current_role === \App\Models\User::ADMIN_ROLE || $current_role === \App\Models\User::OVERSIGHT_SUPERVISOR_ROLE
        ||  $current_role === \App\Models\User::OVERSIGHT_MEMBER_ROLE)
        <div>
            @if ($catchError)
                    ...
                    <div class="tab tab-border">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item" @click.prevent="currentTab = 'home'">
                                <a class="nav-link {{$process_type === '' ? 'active show':''}}" href="#"
                                   ...
                                   id="visits-05-tab" data-bs-toggle="tab" role="tab" aria-controls="visits-05"
                            ...
                            <li class="nav-item" @click.prevent="currentTab = 'form'">
                                @if ($process_type === 'visitDetailsShow')
                                    <a class="nav-link" id="visit-show-05-tab"
                                       ...
                                       data-bs-toggle="tab" role="tab" href="#" aria-controls="visit-show-05"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade {{$process_type === '' ? 'active show':''}}"
                                 :class="currentTab === 'home' ? 'active show':'' " id="visits-05"
                                 role="tabpanel"
