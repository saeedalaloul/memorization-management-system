...
class SummativeExam extends Model
{
    use HasFactory;
    ...
    protected $fillable = [
        ...
        'teacher_id',
        'tester_id',
        'exam_summative_success_mark_id',
        'exam_date',
        'notes',
    ];
    ...
    {
        return $this->belongsTo('App\Models\ExamSummativeSuccessMark', 'exam_summative_success_mark_id');
    }
}
