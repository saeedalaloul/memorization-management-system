...
class CreateStudentsSunnahAttendancesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_sunnah_attendances', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('student_sunnah_attendances');
    }
}
